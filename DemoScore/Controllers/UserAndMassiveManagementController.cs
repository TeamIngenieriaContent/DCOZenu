    ...
    public class UserAndMassiveManagementController : Controller
    {
        ...
        private void SendEmail(string NameUser, string Email, string Usuario, string Company, string Location_Desc)
        {
            ...
            solicitud.Body = "<br/>" +
                ...
                "Sr(a). " + NameUser + "<br/>" +
                "Zenú - Modelo PAR te ha registrado en la plataforma de conocimiento  de nuestro aliado en gestión de conocimiento Content Group." +
               ...
               "<br/>" +
                ...
                "<br/><br/>" + "link:" + "https://www.aprendeyavanza2.com.co/DCOZenu/" +
